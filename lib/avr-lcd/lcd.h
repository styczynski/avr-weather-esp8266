...
/**
 @brief    Display prefix of length n of string without auto linefeed 
 @param    s string to be displayed   
 @param    n length of string prefix to be displayed                                       
 @return   none
*/
extern void lcd_nputs(const char *s, const int n);
